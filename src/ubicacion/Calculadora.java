...
public class Calculadora implements CalculadoraDistancias{
	...
	@Override
	public Boolean seSuperponenLasZonas(ZonaDeCobertura zona1, ZonaDeCobertura zona2) {
	...
	@Override
	public Boolean ubicacionEstaDentroDeZona(Ubicacion ubicacion, ZonaDeCobertura zona) {
